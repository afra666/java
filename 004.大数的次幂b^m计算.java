...
public class Main {
	...
	public static void main(String[] args) {
		...
		BigDecimal b1,m,sumB1 = null;//输入大数,次幂，次幂的结果
...
//		remainder     = b1.remainder(b2)   ;
		...
		b1=scn.nextBigDecimal();
		System.out.println("请输入m=");
		m=scn.nextBigDecimal();
		
		System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
		sumB1=b1.pow(m.intValue());
		System.out.println(sumB1.stripTrailingZeros().toString());
		}
